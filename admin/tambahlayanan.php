...
<head>
  ...
  <title>Hydromart | Tambah Layanan</title>
      ...
      <div class="container-fluid">
        <div class="row mb-2">
                  ...
                  <div class="row">
                    <div class="col-sm-6">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="judul_layanan" placeholder="Silahkan Isi Judul">
                      </div>
                    </div>
                  </div>
                    <!--Image Input -->
          ...
          $gambar=$_FILES['gambar']['name'];    
	        ...
	        move_uploaded_file($lokasi,"../foto_layanan/".$gambar);

           //query untuk menambahkan barang ke database, pastikan urutan nya sama dengan didatabase
           $datas = mysqli_query($koneksi, "INSERT INTO layanan(judul_layanan,isi,gambar) VALUES('$judul_layanan', '$isi', '$gambar')");
           //id layanan tidak dimasukan, karena menggunakan Auto Increment, id akan otomatis
