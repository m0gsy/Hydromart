...
<head>
  ...
  <title>Hydromart | Company Profile</title>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="artikel.php">Profile</a></li>
                  ...
                  <div class="row">
                    <div class="col-sm-6">
                      ...
                      <div class="form-group">
                        <label>Judul</label>
                        <input type="text" class="form-control" name="judul_profile" placeholder="Silahkan Isi Judul">
                      </div>
                    </div>
                  </div>
                    <!--Image Input -->
	        ...
	        move_uploaded_file($lokasi,"../foto_profile/".$nama);
	         $koneksi->query("INSERT INTO profile(judul_profile, isi, gambar) 
		    VALUES('$_POST[judul_profile]', '$_POST[isi]', '$nama')");
