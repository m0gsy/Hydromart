          ...
          <div class="col-sm-6">
            ...
            <div class="card card-warning">
              ...
              <div class="card-body">
                ...
                $datas = mysqli_query($koneksi, "SELECT * FROM artikel WHERE id_artikel = 'id'");
...
if (isset($_POST['submit']))
{
  ...
  $isi = $_POST['isi'];
	...
	if (!empty($lokasifoto))
	{
		move_uploaded_file($lokasifoto, "../foto_artikel/.$gambar");

		//query mengubah artikel
    mysqli_query($koneksi, "UPDATE artikel SET judul_artikel='$judul_artikel', isi='$isi', gambar='$gambar'  WHERE id_artikel ='$id'");
	}
  else
  {
    mysqli_query($koneksi, "UPDATE artikel SET judul_artikel='$judul_artikel', isi='$isi',  WHERE id_artikel='$id'");
  }

	echo "<script>alert('Data Artikel Telah di Ubah');</script>";
