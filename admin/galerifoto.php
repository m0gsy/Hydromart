          ...
          <div class="col-12">
            <div class="card">
              ...
              <div class="card-body">
                ...
                <a href="formgalerifoto.php" class="btn btn-primary">Tambah Galeri Foto</a>
                  <thead>
                  <tr>
                    <th>No.</th>
                    <th>Judul</th>
              ...
              <?php while($pecah = $ambil->fetch_assoc()){ ?>
                  <tr>
                    ...
                    <td>
                    <img src="../foto_galeri/<?php echo $pecah['gambar']; ?>" width="100">
                      </td>
                    <td>
                         <a href="hapusgalerifoto.php?&id=<?php echo $pecah['id_galeri'];?>" class="btn-danger btn">Hapus</a>
                    </td>
                  </tr>
                  <?php $nomor++;?>
                  <?php } ?>
