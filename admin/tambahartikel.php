...
<head>
  ...
  <title>Hydromart | Tambah Artikel</title>
      ...
      <div class="container-fluid">
        <div class="row mb-2">
                  ...
                  <div class="row">
                    <div class="col-sm-6">
                      ...
                      <div class="form-group">
                        <label>Judul</label>
                        <input type="text" class="form-control" name="judul_artikel" placeholder="Silahkan Isi Judul">
                      </div>
                    </div>
                  </div>
                    <!--Image Input -->
          ...
          $isi = $_POST['isi'];
	        ...
	        move_uploaded_file($lokasi,"../foto_artikel/".$gambar);
	         
          //query untuk menambahkan barang ke database, pastikan urutan nya sama dengan didatabase
          $datas = mysqli_query($koneksi, "INSERT INTO artikel(judul_artikel,isi,gambar) VALUES('$judul_artikel', '$isi', '$gambar')");
