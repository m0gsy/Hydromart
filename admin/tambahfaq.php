...
<head>
  ...
  <title>Hydromart | Tambah FAQ</title>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Form FAQ</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
                  ...
                  <div class="row">
                    <div class="col-sm-6">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="pertanyaan" placeholder="Silahkan Isi Judul">
                      </div>
                    </div>
                  </div>
                    <!-- text input -->
                    ...
                    <form action="#" method="POST" name="postform" enctype="multipart/form-data">
                     <tr>
                    <td><textarea class="ckeditor" id="ckedtor" name="jawaban"></textarea></td>
                    </tr>
                    <br>
          ...
          $datas = mysqli_query($koneksi, "INSERT INTO faq(pertanyaan, jawaban) VALUES('$pertanyaan', '$jawaban')");
